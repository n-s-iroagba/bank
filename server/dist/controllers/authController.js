...
class AuthController {
    constructor() {
        ...
        this.signUp = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { result, user } = yield this.authService.signUp(req.body);
        ...
        this.resendCode = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const newToken = yield this.authService.generateNewCode(token, id);
        ...
        this.loginAccountHolder = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.authService.loginAccountHolder({ username, password });
