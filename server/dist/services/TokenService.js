    ...
    generateResetPasswordToken(payload, customExpiresIn) {
        ...
        try {
            ...
            const options = {
                ...
                issuer: this.defaultOptions.issuer,
                audience: this.defaultOptions.audience,
                subject: ((_a = payload.userId) === null || _a === void 0 ? void 0 : _a.toString()) || ((_b = payload.adminId) === null || _b === void 0 ? void 0 : _b.toString()),
            };
            const signOptions = {
                expiresIn: options.expiresIn,
                issuer: options.issuer,
    ...
    generateEmailVerificationToken(user, customExpiresIn) {
        ...
        try {
            ...
            const options = {
                ...
                issuer: this.defaultOptions.issuer,
                audience: this.defaultOptions.audience,
                subject: (_a = user.id) === null || _a === void 0 ? void 0 : _a.toString(),
            };
            const signOptions = {
                expiresIn: options.expiresIn,
                issuer: options.issuer,
