...
class UserService {
    findUserByEmail(email_1) {
        return __awaiter(this, arguments, void 0, function* (email, shouldThrowError = false) {
            try {
                const user = yield repositories_1.userRepository.findUserByEmail(email);
    ...
    findUserById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield repositories_1.userRepository.findUserById(id);
                if (!user) {
    ...
    findUserByResetToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const hashedToken = cryptoUtil_1.CryptoUtil.hashString(token);
                const user = yield repositories_1.userRepository.findUserByResetToken(hashedToken);
                if (!user) {
                    const users = yield repositories_1.userRepository.getAllUsers();
                    console.log(users);
    ...
    findUserByVerificationToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const user = yield repositories_1.userRepository.findUserByVerificationToken(token);
                if (!user) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (existingUser) {
                    ...
                    throw new errors_1.UnauthorizedError('User already exists');
                }
                const user = yield repositories_1.userRepository.createUser(userData);
    ...
    updateUserVerification(user, verificationCode, verificationToken) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const updatedUser = yield repositories_1.userRepository.updateUserById(user.id, updates);
                if (!updatedUser) {
